...
package com.kovtun.producdetector.bluetooth_driver;
...
import com.kovtun.producdetector.R;
...
public class DeviceList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(strBluetoothDevices == null) 
        	strBluetoothDevices = "Устройства BLUETOOTH";
